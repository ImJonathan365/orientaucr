...
public class ImageUtils {
    ...
    public static String saveProfilePicture(MultipartFile imageFile, String uploadDir) throws IOException {
        ...
        if (contentType == null || !(contentType.equals("image/jpeg") || contentType.equals("image/png"))) {
            throw new IOException("Tipo de archivo no permitido. Solo JPG o PNG son aceptados para fotos de perfil.");
        }

        String originalFilename = imageFile.getOriginalFilename();
        if (originalFilename == null || !originalFilename.matches("^[a-zA-Z0-9_.-]+\\.(jpg|jpeg|png)$")) {
            throw new IOException("Nombre de archivo inválido. Solo se permiten letras, números, punto y guion.");
        }
